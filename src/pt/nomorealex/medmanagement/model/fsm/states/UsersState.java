...
public class UsersState extends ServiceAPIStateAdapter {

    public UsersState(ServiceAPIContext context, DataBucket dataBucket) {
        super(context,dataBucket);
    }

    @Override
    public ServiceAPIStates getState() {
        return ServiceAPIStates.USERSSTATE;
    }
