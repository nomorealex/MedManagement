...
public class MainState extends ServiceAPIStateAdapter {

    public MainState(ServiceAPIContext context, DataBucket dataBucket) {
        super(context,dataBucket);
    }

    @Override
    public ServiceAPIStates getState() {
        return ServiceAPIStates.MAINSTATE;
    }
